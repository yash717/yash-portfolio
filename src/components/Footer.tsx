      ...
      <Section href="contact" className="relative flex flex-col items-center">
        ...
        >
          ...
          {SITE_CONFIG.contact.phone && (
            <Button asChild variant="default" className="group relative flex items-center gap-3">
              <Link href={`tel:${SITE_CONFIG.contact.phone.replace(/\s/g, "")}`}>
                <Phone className="size-4 transition-all duration-500 sm:size-5" />
                <span className="text-sm font-medium tracking-wide sm:text-base">Call me</span>
                <ArrowUpRight
                  className="size-4 transition-all duration-500 sm:size-5 group-hover:translate-x-[3px] group-hover:-translate-y-[3px] group-hover:scale-110"
                  strokeWidth={1.5}
                />
