    ...
    <section className="min-h-screen flex flex-col relative overflow-hidden pb-15">
      <div className="flex-1 grid grid-cols-1 md:grid-cols-12 relative z-10 h-full">
        <div className="md:col-span-8 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 flex flex-col justify-center px-8 md:px-16 py-12">
            <div className="relative">
              <MotionH1 className="text-[17vw] md:text-[8vw] font-black leading-[0.75] uppercase text-primary select-none flex flex-col items-center md:items-start text-center md:text-left">
                ...
                <div className="overflow-x-visible overflow-y-hidden">
                  <MotionSpan
                    ...
                    animate={{ y: 0 }}
                    transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1] }}
                    className="block font-payback text-foreground mt-5 md:ml-60 whitespace-nowrap"
                  >
                    {lastName}
                  </MotionSpan>
                </div>
        ...
        <div className="md:col-span-4 relative bg-secondary/10 group overflow-hidden h-[400px] md:h-auto">
          ...
          >
            <Image
              src={image.startsWith("/") ? image : `https://images.weserv.nl/?url=${image}&output=webp`}
              alt={name}
              fill
              fetchPriority="high"
